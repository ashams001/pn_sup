...
<link rel="stylesheet" href="./assets/css/pages/403.css">
    <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center" style="text-align: center;">
            <a class="navbar-brand brand-logo-mini" href="./orders/supplier_dashboard.php"><img src="./assets/images/site_logo.png" alt="logo" style="height: 50px;"/></a>
        </div>
    </nav>

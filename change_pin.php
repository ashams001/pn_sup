...
if (count($_POST) > 0) {
    ...
    if($error){
        ...
        $sql1 = "UPDATE `sup_account_users` SET u_password_pin='" . $_POST["newpin"] . "' where user_name = '$mob'";
        ...
        mysqli_query($db, "UPDATE sup_account_users set u_status = '0' where user_name = '$mob'");
    }
...
<head>
    ...
    <title><?php echo $sitename; ?> | Change Pin</title>
    <!-- Global stylesheets -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Change Pin</h5>
                <hr/>
                ...
                <?php if ($temp == "one") { ?>
                    <div class="alert alert-success no-border">
                        ...
                        <span class="text-semibold">Pin !</span> has been changed successfully.
                    </div>
                <?php } ?>
                <?php if ($error) { ?>
                    <div class="alert alert-success no-border">
                        <button type="button" class="close" data-dismiss="alert">
                            <span>&times;</span><span class="sr-only">Close</span></button>
                        <span class="text-semibold">Pin</span> validation failure: <?php echo $error ?>
                    </div>
                <?php } ?>
                ...
                <form action="" id="id" method="post">
                    <div id="col-md-6 mobile" >
                        <br/>
                        <label><b>Enter New Pin: </b></label>
                        <input type="password" class="form-control" name="newpin" id="newpin"
...
<script>
    window.onload = function () {
        history.replaceState("", "", "<?php echo $scriptName; ?>change_pin.php");
    }
</script>

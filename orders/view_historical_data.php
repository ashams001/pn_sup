                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body" style="padding: 3.8rem 0.8rem 0.8rem 0.8rem!important; margin: auto;">
                                                    <?php
                                                    ...
                                                    while ($rowc = mysqli_fetch_array($qur)) {
                                                        ...
                                                        <div class="hori-timeline" dir="ltr">
                                                            ...
                                                            <li class="list-inline-item event-list">
                                                                <div class="px-4">
                                                                    <?php if($osid == 5){?>
                                                                        <div class="event-date text-white" style="background-color: #086c2b;"><?php echo $o_status[0] ?> <br> <?php echo $o_status[1] ?></div>
																	<?php }else{?>
                                                                    <div class="event-date bg-soft-primary"><?php echo $o_status[0] ?> <br> <?php echo $o_status[1] ?></div>
                                                                    <?php }?>
                                                                    <p><span class="text-gray font-weight-bold"><?php echo dateReadFormat($rowc['created_on']); ?></span></p>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                        </div>
                                                ...
                                                <div class="card-body" style="padding: 0rem 0.8rem 0.8rem 0.8rem!important; margin: auto 5%;">
                                                    <div class="top_row cr">
															...
															<?php
																...
																while($row3 = mysqli_fetch_array($qur3)){
																	...
																	<?php if(!empty($file_name)){ ?>
                                                                        ...
                                                                        <div class="" style="font-size: 20px!important;text-align: center;margin-top: 4px;">

                                            ...
                                            <div class="col-md-12">
                                                <div class="panel">
                                                    ...
                                                    <div class="panel-body table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                $index_left = 1;
                                                                $index_right = 2;
                                                                $c_query = "SELECT count(*) as tot_count FROM sup_order";
                                                                $c_qur = mysqli_query($sup_db, $c_query);
                                                                $c_rowc = mysqli_fetch_array($c_qur);
                                                                $tot_orders = $c_rowc['tot_count'];
                                                                $query = sprintf("SELECT * FROM  sup_order  where order_active = 0 and is_deleted != 1 and c_id = '$user_id'  order by created_on DESC LIMIT " . $start_index . ',' . $tab_num_rec);
                                                    ...
                                                    <div class="panel-footer">
                                                        <div class="row">
                                                            <?php
                                                            $remainder = $tot_orders % $tab_num_rec;
                                                            $quotient = ($tot_orders - $remainder) / $tab_num_rec;
